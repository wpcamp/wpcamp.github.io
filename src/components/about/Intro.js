    ...
    <Fragment>
      ...
      <div className="about_text w-full h-auto clear-both float-left border-solid border-[#DFDFDF] border-b pb-[31px] mb-[30px]">
        <p className="mb-[11px]">
          ...
          Currently, I am working as a Research Assistant at Dartmouth College's HealthX Lab, on a new project with computer science PhD students and faculty to explore the use of large language models (LLMs) and mobile apps for mental health.
      ...
      <div className="tokyo_tm_button" data-position="left">
        <a href="assets/img/cv/Campbell-1-1.pdf" download>
